...
class AutosControllerTest < ActionController::TestCase
  ...
  test "should create auto" do
    assert_difference('Auto.count') do
      post :create, auto: { color: @auto.color, modelo: @auto.modelo, name: @auto.name, precio: @auto.precio, year: @auto.year }
    end
  ...
  test "should update auto" do
    patch :update, id: @auto, auto: { color: @auto.color, modelo: @auto.modelo, name: @auto.name, precio: @auto.precio, year: @auto.year }
    assert_redirected_to auto_path(assigns(:auto))
  end
